     ...
     extends Hud
 {
     ...
     public Watermark() {
         ...
         this.size = register(new Setting("Size", 1.0F, 5.0F, 0.5F));
     ...
     public void onRender() {
         ...
         RenderUtil.drawString("Candy+ Rewrite v0.3.4", this.x.getValue() + 10.0F + this.offsetx, this.y.getValue() + 5.0F, ColorUtil.toRGBA(this.color.getValue()), this.shadow.getValue(), size);
